...
static int32_t msm_sensor_driver_platform_probe(struct platform_device *pdev)
{
	...
	struct msm_sensor_ctrl_t *s_ctrl_2 = NULL;
	match = of_match_device(msm_sensor_driver_dt_match, &pdev->dev);
	s_ctrl_2 = (struct msm_sensor_ctrl_t *)match->data;
	...
	if (!s_ctrl->func_tbl)
		s_ctrl->func_tbl = s_ctrl_2->func_tbl;
