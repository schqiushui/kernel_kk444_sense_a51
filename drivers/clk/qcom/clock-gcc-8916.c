...
int clk_get_cpu_idx_8916(struct clk *c)
{
...
int clk_get_l2_idx_8916(struct clk *c)
{
	return -1;
}
...
{
	extern int clk_get_cpu_idx_8939(struct clk *c);
	int cpu;

	cpu = clk_get_cpu_idx_8916(c);
	if (cpu >= 0)
		return cpu;

	cpu = clk_get_cpu_idx_8939(c);
	if (cpu >= 0)
		return cpu;
...
{
	extern int clk_get_l2_idx_8939(struct clk *c);
	int l2;

	l2 = clk_get_l2_idx_8916(c);
	if (l2 >= 0)
		return l2;

	l2 = clk_get_l2_idx_8939(c);
	if (l2 >= 0)
		return l2;
